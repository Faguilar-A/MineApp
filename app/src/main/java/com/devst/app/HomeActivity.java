...
public class HomeActivity extends AppCompatActivity {
    ...
    // Launcher para pedir permiso de cámara en tiempo de ejecución (para linterna)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAbrirWeb.setOnClickListener(v -> {
            Uri uri = Uri.parse("https://www.minecraft.net/es-es");
        ...
        // Evento: Intent implícito → enviar SMS (interfaz del sistema)
        btnCompartir.setOnClickListener(v -> {
            Intent smsIntent = new Intent(Intent.ACTION_SENDTO);
            smsIntent.setData(Uri.parse("smsto:"));
            smsIntent.putExtra("sms_body", "Hola desde mi app Android 😎");
            startActivity(smsIntent);
        });

        // Evento para el botón de calendario implicito -> abrir calendario
        btnCalendario.setOnClickListener(v -> {
            Intent i = new Intent(HomeActivity.this, CalendarioActivity.class);
            startActivity(i);
        });
        // Evento para el botón de configuración -> configurar wifi y bluthoo
        ...
        // Linterna - Inicializamos la cámara para usar el flash
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_perfil) {
            ...
            // Abrir web (implícito)
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.minecraft.net/es-es")));
            return true;
